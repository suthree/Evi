...
test("context bundle includes bounded GA project design plan", async () => {
  ...
  try {
    ...
    assert.match(rendered.markdown, /evidence_basis: packages\/core\/src\/ga_project_design\.ts \| packages\/core\/src\/action_contracts\.ts \| packages\/core\/src\/delegate_agent_contract\.ts \| packages\/core\/src\/schemas\.ts \| packages\/runtime\/src\/runner\.ts/);
