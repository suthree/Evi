    ...
    general_delegation_loop: {
      ...
      runner_enforcement_contract: {
        ...
        completion_gate: [
          ...
          "delegatedVerificationRefs rejects exact delegated result ids or persisted delegated result refs",
