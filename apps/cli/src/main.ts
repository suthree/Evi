...
function printUsage(): void {
  ...
  pnpm run runtime -- goal resume --goal goal_... [--repo-root /same/absolute/worktree] [--confirm-effect goal_effect_...] [--command-id goal_command_...] [--state-root .runtime/state]
  ...
  pnpm run runtime -- deployment controller-handoff [--state-root ~/.local-runtime/state/runtime]
  ...
  pnpm run runtime -- environment baseline [--repo-root .] [--test-state-root .runtime/smoke/environment-baseline] [--limit 20] [--state-root .runtime/state]
