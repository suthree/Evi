  ...
  return {
    ...
    replay_audit_contract: {
      ...
      proof_boundary: [
        ...
        "replay audit warns when a model-action envelope has duplicate event bindings or its event binds more than one envelope before trusting its input metadata",
