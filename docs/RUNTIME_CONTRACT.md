...
the parser removes invisible format characters before applying the shared
authority and mutation checks, so an obfuscated `f\u200bix` is still rejected
before delegated dispatch. Neither
